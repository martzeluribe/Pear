    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-grow bg-gray-100 p-6 flex justify-center items-start">
                <Head title="Erabiltzailea Editatu" />
                ...
                <div className="w-full max-w-lg bg-white shadow-lg rounded-3xl p-8 border border-blue-400 mt-4">
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        {/* Pasahitza */}
                        <div>
                            <label className="block text-md font-medium text-gray-700 mb-1">Pasahitza (opcional)</label>
                            <input
                                type="password"
                                placeholder="••••••••"
                                value={data.password}
                        ...
                        {/* Botones: Itzuli a la izquierda y Editatu (Amarillo) a la derecha */}
                        <div className="flex items-center justify-between pt-6">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="bg-[#9db1d6] hover:bg-[#8ca2cb] text-black px-10 py-2 rounded-2xl font-medium shadow-md transition disabled:opacity-50 min-w-[200px]"
                            >
                                Editatu
                            </button>
                        </div>
